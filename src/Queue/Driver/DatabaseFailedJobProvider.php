...
use Throwable;
use Laika\Engine\Queue\Model\FailedJobModel;
use Laika\Engine\Queue\Exceptions\DriverException;
 ...
 * FailedJobModel. Register the connection with Laika\Engine\Model\Connection::add(...)
