 ...
 * @method static \Laika\Engine\Cache\Contracts\CacheDriverInterface store(string $name)
 * @method static \Laika\Engine\Cache\Contracts\CacheDriverInterface driver(?string $name = null)
