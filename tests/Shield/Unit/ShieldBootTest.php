...
namespace Laika\Engine\Shield\Tests\Unit;

use Laika\Engine\Shield\ShieldConfig;
use Laika\Engine\Shield\Rules\CountryRule;
use Laika\Engine\Shield\Rules\IpRule;
use Laika\Engine\Shield\Rules\IpVersionRule;
use Laika\Engine\Shield\Rules\RateLimitRule;
use Laika\Engine\Shield\Rules\RequestFilterRule;
use Laika\Engine\Shield\Rules\SqlInjectionRule;
use Laika\Engine\Shield\Rules\XssRule;
use Laika\Engine\Shield\Shield;
use PHPUnit\Framework\TestCase;
use ReflectionProperty;

/**
 * @covers \Laika\Engine\Shield\Shield
 */
class ShieldBootTest extends TestCase
{
    ...
    public function testAcceptsAConfigObject(): void
    {
        ...
        $rules = $this->prop(\Laika\Engine\Shield\Shield::fromConfig($config), 'rules');
