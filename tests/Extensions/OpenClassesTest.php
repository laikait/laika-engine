...
class OpenClassesTest extends TestCase
{
    ...
    public static function openClasses(): array
    {
        $classes = [
            ...
            \Laika\Engine\Core\App\Resource::class,
            \Laika\Engine\Core\Helper\MimeType::class,
            \Laika\Engine\Core\Nav\Helper\Renderer::class,
            \Laika\Engine\Core\Generator\Icon::class,
            \Laika\Engine\Core\Generator\Uid::class,
            \Laika\Engine\Core\Log\Activity::class,
            \Laika\Engine\Core\Template\FragmentCache::class,
            \Laika\Engine\Core\System\MemoryManager::class,
    ...
    public static function securityBoundaries(): array
    {
        $classes = [
            ...
            \Laika\Engine\Core\Http\ProxyTrust::class,
