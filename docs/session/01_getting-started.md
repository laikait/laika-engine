...
| Class | Job |
|---|---|
| `Laika\Engine\Session\SessionConfig` | Selects the driver and holds session options and cookie parameters |
| `Laika\Engine\Session\Session` | Reads and writes session data |
| `Laika\Engine\Session\SessionManager` | Starts and destroys the session |
