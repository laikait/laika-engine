...
Every driver implements `Laika\Engine\Session\Contracts\SessionDriverInterface`:
...
Everything is thrown as `Laika\Engine\Session\Exceptions\SessionHandlerException`:
...
protected function tearDown(): void
{
    ...
    \Laika\Engine\Session\SessionManager::reset(); // handler, started flag, setup flag
    \Laika\Engine\Session\SessionConfig::reset();  // driver, params, options, cookies
}
```
